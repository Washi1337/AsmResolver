...
namespace AsmResolver.Workspaces.DotNet.Tests
{
    public class InheritanceTest : IClassFixture<TestCasesFixture>
    {
        ...
        public void InterfaceImplementation()
        {
            ...
            Assert.Contains(interfaceType, node.ForwardRelations.GetObjects(DotNetRelations.BaseType));
        }
        ...
        public void DerivedClassRelation()
        {
            ...
            Assert.Contains(classType, node.ForwardRelations.GetObjects(DotNetRelations.BaseType));
        }
