...
public abstract class CodeViewLeaf : ICodeViewLeaf
{
        ...
        ref BinaryStreamReader dataReader)
    {
        ...
        return kind switch
        {
            ...
            BClass or BInterface => new SerializedBaseClassField(context, typeIndex, ref dataReader),
            ...
            Index => new SerializedIndexField(context, typeIndex, ref dataReader),
            Label => new SerializedLabelTypeRecord(typeIndex, dataReader),
            ...
            MFuncId => new SerializedMemberFunctionIdentifier(context, typeIndex, dataReader),
            ...
            UdtSrcLine => new SerializedUdtSourceLineLeaf(context, typeIndex, dataReader),
            UdtModSrcLine => new SerializedUdtModuleSourceLineLeaf(context, typeIndex, dataReader),
            ...
            VFTable => new SerializedVFTableTypeRecord(context, typeIndex, dataReader),
