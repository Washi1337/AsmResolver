...
/// <summary>
/// Provides a lazily initialized implementation of <see cref="UnionType"/> that is read from a PDB image.
/// </summary>
public class SerializedUnionType : UnionType
{
    ...
    public SerializedUnionType(PdbReaderContext context, uint typeIndex, BinaryStreamReader reader)
        : base(typeIndex)
    {
        _context = context;
