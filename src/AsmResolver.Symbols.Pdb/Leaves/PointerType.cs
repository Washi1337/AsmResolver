...
/// </summary>
public class PointerType : CodeViewType
{
    ...
    protected PointerType(uint typeIndex)
        : base(typeIndex)
    {
    ...
    public PointerType(CodeViewType type, PointerAttributes attributes)
        : base(0)
    {
    ...
    public PointerType(CodeViewType type, PointerAttributes attributes, byte size)
        : base(0)
    {
        _baseType = new LazyVariable<CodeViewType>(type);
        Attributes = attributes;
