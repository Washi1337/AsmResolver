...
/// <summary>
/// Represents a lazily initialized implementation of <see cref="Compile2Symbol"/> that is read from a PDB image.
/// </summary>
public class SerializedCompile2Symbol : Compile2Symbol
{
