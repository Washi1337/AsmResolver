...
namespace AsmResolver.DotNet.Builder
{
    public partial class DotNetDirectoryBuffer : ITypeCodedIndexProvider
    {
        ...
        public uint GetTypeDefOrRefIndex(ITypeDefOrRef? type, object? diagnosticSource = null)
        {
            ...
            {
                TableIndex.TypeDef => GetTypeDefinitionTokenOrImport(type as TypeDefinition, diagnosticSource),
        ...
        private uint AddMemberRefParent(IMemberRefParent? parent, object? diagnosticSource = null)
        {
            ...
            {
                TableIndex.TypeDef => GetTypeDefinitionTokenOrImport(parent as TypeDefinition, diagnosticSource),
                ...
                TableIndex.Method => GetMethodDefinitionTokenOrImport(parent as MethodDefinition, diagnosticSource),
        ...
        private uint AddMethodDefOrRef(IMethodDefOrRef? method, object? diagnosticSource = null)
        {
            ...
            {
                TableIndex.Method => GetMethodDefinitionTokenOrImport(method as MethodDefinition, diagnosticSource),
        ...
        private uint AddCustomAttributeType(ICustomAttributeType? constructor, object? diagnosticSource = null)
        {
            ...
            {
                TableIndex.Method => GetMethodDefinitionTokenOrImport(constructor as MethodDefinition, diagnosticSource),
