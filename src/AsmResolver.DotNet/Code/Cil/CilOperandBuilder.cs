...
namespace AsmResolver.DotNet.Code.Cil
{
    ...
    public class CilOperandBuilder : ICilOperandBuilder
    {
        ...
        private MetadataToken GetMemberToken(IMetadataMember member) => member.MetadataToken.Table switch
        {
            ...
            TableIndex.TypeDef => _provider.GetOrImportTypeDefinitionToken((TypeDefinition) member, _diagnosticSource),
            TableIndex.TypeSpec => _provider.GetTypeSpecificationToken((TypeSpecification) member, _diagnosticSource),
            TableIndex.Field => _provider.GetOrImportFieldDefinitionToken((FieldDefinition) member, _diagnosticSource),
            TableIndex.Method => _provider.GetOrImportMethodDefinitionToken((MethodDefinition) member, _diagnosticSource),
