...
namespace AsmResolver.X86
{
    ...
    public static partial class X86OpCodes
    {
        ...
        public static readonly X86OpCode Add_RegOrMem8_Reg8 = new X86OpCode(X86Mnemonic.Add, 0x00,
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.Register << 0x08) | (byte)X86OperandSize.Byte, true);

        public static readonly X86OpCode Add_RegOrMem1632_Reg1632 = new X86OpCode(X86Mnemonic.Add, 0x01,
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x18) | ((byte)X86OperandSize.WordOrDword << 0x10) |
            ((byte)X86AddressingMethod.Register << 0x08) | (byte)X86OperandSize.WordOrDword, true);

        public static readonly X86OpCode Add_Reg8_RegOrMem8 = new X86OpCode(X86Mnemonic.Add, 0x02,
            ((byte)X86AddressingMethod.Register << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x08) | (byte)X86OperandSize.Byte, true);

        public static readonly X86OpCode Add_Reg1632_RegOrMem1632 = new X86OpCode(X86Mnemonic.Add, 0x03,
            ((byte)X86AddressingMethod.Register << 0x18) | ((byte)X86OperandSize.WordOrDword << 0x10) |
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x08) | (byte)X86OperandSize.WordOrDword, true);

        public static readonly X86OpCode Add_Al_Imm8 = new X86OpCode(X86Mnemonic.Add, 0x04,
            ((byte)X86AddressingMethod.ImmediateData << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.RegisterAl << 0x08) | (byte)X86OperandSize.Byte, false);

        public static readonly X86OpCode Add_Eax_Imm1632 = new X86OpCode(X86Mnemonic.Add, 0x05,
            ((byte)X86AddressingMethod.ImmediateData << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.RegisterEax << 0x08) | (byte)X86OperandSize.WordOrDword, false);

        public static readonly X86OpCode Push_Es = new X86OpCode(X86Mnemonic.Push, 0x06,
            ((byte)X86AddressingMethod.None << 0x18) | ((byte)X86OperandSize.None << 0x10) |
            ((byte)X86AddressingMethod.None << 0x08) | (byte)X86OperandSize.None, true);
        ...
        public static readonly X86OpCode Sbb_Eax_Imm1632 = new X86OpCode(X86Mnemonic.Sbb, 0x1D,
            ((byte)X86AddressingMethod.ImmediateData << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.RegisterEax << 0x08) | (byte)X86OperandSize.Dword, false);
        ...
        public static readonly X86OpCode Inc_Eax = new X86OpCode(X86Mnemonic.Inc, 0x40,
            ((byte)X86AddressingMethod.OpCodeRegister << 0x18) | ((byte)X86OperandSize.WordOrDword << 0x10) |
            ((byte)X86AddressingMethod.None << 0x08) | (byte)X86OperandSize.None, false);
        ...
        public static readonly X86OpCode Bound = new X86OpCode(X86Mnemonic.Bound, 0x62,
            ((byte)X86AddressingMethod.Register << 0x18) | ((byte)X86OperandSize.WordOrDword << 0x10) |
            ((byte)X86AddressingMethod.MemoryAddress << 0x08) | (byte)X86OperandSize.DwordOrQword, true);

        public static readonly X86OpCode Arpl = new X86OpCode(X86Mnemonic.Arpl, 0x63,
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x18) | ((byte)X86OperandSize.Word << 0x10) |
            ((byte)X86AddressingMethod.Register << 0x08) | (byte)X86OperandSize.Word, true);
        ...
        public static readonly X86OpCode Push_Imm1632 = new X86OpCode(X86Mnemonic.Push, 0x68,
            ((byte)X86AddressingMethod.ImmediateData << 0x18) | ((byte)X86OperandSize.WordOrDword << 0x10) |
            ((byte)X86AddressingMethod.None << 0x08) | (byte)X86OperandSize.None, false);
        ...
        public static readonly X86OpCode Jo_Rel8 = new X86OpCode(X86Mnemonic.Jo, 0x70,
            ((byte)X86AddressingMethod.RelativeOffset << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.None << 0x08) | (byte)X86OperandSize.None, false);
        ...
        public static readonly X86OpCode Arithmetic_RegOrMem8_Imm8 = new X86OpCode(new X86Mnemonic[]
        {
            ...
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.ImmediateData << 0x08) | (byte)X86OperandSize.Byte, true, true);
        ...
        public static readonly X86OpCode Arithmetic_RegOrMem32_Imm1632 = new X86OpCode(new X86Mnemonic[]
        {
            ...
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x18) | ((byte)X86OperandSize.Dword << 0x10) |
            ((byte)X86AddressingMethod.ImmediateData << 0x08) | (byte)X86OperandSize.WordOrDword, true, true);
        ...
        public static readonly X86OpCode Arithmetic_RegOrMem32_Imm1632_2 = new X86OpCode(new X86Mnemonic[]
        {
            X86Mnemonic.Add, X86Mnemonic.Or, X86Mnemonic.Adc, X86Mnemonic.Sbb, 
            X86Mnemonic.And, X86Mnemonic.Sub, X86Mnemonic.Xor, X86Mnemonic.Cmp
        }, 0x00008300,
        ...
        public static readonly X86OpCode Mov_RegOrMem16_SReg = new X86OpCode(X86Mnemonic.Mov, 0x8C,
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x18) | ((byte)X86OperandSize.Word << 0x10) |
            ((byte)X86AddressingMethod.SegmentRegister << 0x08) | (byte)X86OperandSize.Word, true);

        public static readonly X86OpCode Lea_RegOrMem1632_Mem32 = new X86OpCode(X86Mnemonic.Lea, 0x8D,
            ((byte)X86AddressingMethod.Register << 0x18) | ((byte)X86OperandSize.WordOrDword << 0x10) |
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x08) | (byte)X86OperandSize.Dword, true);

        public static readonly X86OpCode Mov_SReg_RegOrMem16 = new X86OpCode(X86Mnemonic.Mov, 0x8E,
            ((byte)X86AddressingMethod.SegmentRegister << 0x18) | ((byte)X86OperandSize.Word << 0x10) |
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x08) | (byte)X86OperandSize.Word, true);
        ...
        public static readonly X86OpCode Call_Far_Rel48 = new X86OpCode(X86Mnemonic.Call_Far, 0x9A,
            ((byte)X86AddressingMethod.DirectAddress << 0x18) | ((byte)X86OperandSize.Fword << 0x10) |
            ((byte)X86AddressingMethod.None << 0x08) | (byte)X86OperandSize.None, false);
        ...
        public static readonly X86OpCode Mov_Al_Mem8 = new X86OpCode(X86Mnemonic.Mov, 0xA0,
            ((byte)X86AddressingMethod.RegisterAl << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.MemoryAddress << 0x08) | (byte)X86OperandSize.Byte, false);

        public static readonly X86OpCode Mov_Eax_Mem1632 = new X86OpCode(X86Mnemonic.Mov, 0xA1,
            ((byte)X86AddressingMethod.RegisterEax << 0x18) | ((byte)X86OperandSize.WordOrDword << 0x10) |
            ((byte)X86AddressingMethod.MemoryAddress << 0x08) | (byte)X86OperandSize.WordOrDword, false);

        public static readonly X86OpCode Mov_Mem8_Al = new X86OpCode(X86Mnemonic.Mov, 0xA2,
            ((byte)X86AddressingMethod.MemoryAddress << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.RegisterAl << 0x08) | (byte)X86OperandSize.Byte, false);

        public static readonly X86OpCode Mov_Mem1632_Eax = new X86OpCode(X86Mnemonic.Mov, 0xA3,
            ((byte)X86AddressingMethod.MemoryAddress << 0x18) | ((byte)X86OperandSize.WordOrDword << 0x10) |
            ((byte)X86AddressingMethod.RegisterEax << 0x08) | (byte)X86OperandSize.WordOrDword, false);
        ...
        public static readonly X86OpCode Test_Al_Imm8 = new X86OpCode(X86Mnemonic.Test, 0xA8,
            ((byte)X86AddressingMethod.RegisterAl << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.ImmediateData << 0x08) | (byte)X86OperandSize.Byte, false);

        public static readonly X86OpCode Test_Eax_Imm1632 = new X86OpCode(X86Mnemonic.Test, 0xA9,
            ((byte)X86AddressingMethod.RegisterEax << 0x18) | ((byte)X86OperandSize.WordOrDword << 0x10) |
            ((byte)X86AddressingMethod.ImmediateData << 0x08) | (byte)X86OperandSize.WordOrDword, false);
        ...
        public static readonly X86OpCode Mov_Al_Imm8 = new X86OpCode(X86Mnemonic.Mov, 0xB0,
            ((byte)X86AddressingMethod.OpCodeRegister << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.ImmediateData << 0x08) | (byte)X86OperandSize.Byte, false);
        ...
        public static readonly X86OpCode Retn_Imm16 = new X86OpCode(X86Mnemonic.Retn, 0xC2,
            ((byte)X86AddressingMethod.ImmediateData << 0x18) | ((byte)X86OperandSize.Word << 0x10) |
            ((byte)X86AddressingMethod.None << 0x08) | (byte)X86OperandSize.None, false);
        ...
        public static readonly X86OpCode Les_Reg1632_MemOrReg1632 = new X86OpCode(X86Mnemonic.Les, 0xC4,
            ((byte)X86AddressingMethod.Register << 0x18) | ((byte)X86OperandSize.WordOrDword << 0x10) |
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x08) | (byte)X86OperandSize.WordOrDword, false);
        ...
        public static readonly X86OpCode BitShift_RegOrMem8_1 = new X86OpCode(new X86Mnemonic[]
        {
            ...
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.ImmediateOne << 0x08) | (byte)X86OperandSize.None, true, true);
        ...
        public static readonly X86OpCode BitShift_RegOrMem8_Cl = new X86OpCode(new X86Mnemonic[]
        {
            ...
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.RegisterCl << 0x08) | (byte)X86OperandSize.Byte, true, true);
        ...
        public static readonly X86OpCode In_Eax_Imm8 = new X86OpCode(X86Mnemonic.In, 0xE5,
            ((byte)X86AddressingMethod.RegisterEax << 0x18) | ((byte)X86OperandSize.Dword << 0x10) |
            ((byte)X86AddressingMethod.ImmediateData << 0x08) | (byte)X86OperandSize.Byte, false);
        ...
        public static readonly X86OpCode Call_Rel1632 = new X86OpCode(X86Mnemonic.Call, 0xE8,
            ((byte)X86AddressingMethod.RelativeOffset << 0x18) | ((byte)X86OperandSize.Dword << 0x10) |
            ((byte)X86AddressingMethod.None << 0x08) | (byte)X86OperandSize.None, false);
        ...
        public static readonly X86OpCode In_Al_Dx = new X86OpCode(X86Mnemonic.In, 0xEC,
            ((byte)X86AddressingMethod.RegisterAl << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.RegisterDx << 0x08) | (byte)X86OperandSize.Word, false);
        ...
        public static readonly X86OpCode Out_Dx_Al = new X86OpCode(X86Mnemonic.Out, 0xEE,
            ((byte)X86AddressingMethod.RegisterDx << 0x18) | ((byte)X86OperandSize.Word << 0x10) |
            ((byte)X86AddressingMethod.RegisterAl << 0x08) | (byte)X86OperandSize.Byte, false);
        ...
        public static readonly X86OpCode F6 = new X86OpCode(new X86Mnemonic[]
        {
            ...
            new X86AddressingMethod[]
            {
                X86AddressingMethod.RegisterOrMemoryAddress,
                X86AddressingMethod.RegisterOrMemoryAddress,
                X86AddressingMethod.RegisterOrMemoryAddress,
                X86AddressingMethod.RegisterOrMemoryAddress,
                X86AddressingMethod.RegisterOrMemoryAddress,
            ...
            new X86AddressingMethod[]
            {
                X86AddressingMethod.ImmediateData,
                X86AddressingMethod.ImmediateData,
                X86AddressingMethod.None,
                X86AddressingMethod.None,
                X86AddressingMethod.None,
                X86AddressingMethod.None,
                X86AddressingMethod.None,
        ...
        public static readonly X86OpCode FE = new X86OpCode(new X86Mnemonic[]
        {
            ...
            ((byte)X86AddressingMethod.RegisterOrMemoryAddress << 0x18) | ((byte)X86OperandSize.Byte << 0x10) |
            ((byte)X86AddressingMethod.None << 0x08) | (byte)X86OperandSize.None, true, true);
